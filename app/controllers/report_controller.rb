class ReportController < ApplicationController
    ...
    def show
        ...
        @fromtime1 = DateTime.new( fromtime["fromtime1(1i)"].to_i, fromtime["fromtime1(2i)"].to_i, fromtime["fromtime1(3i)"].to_i,  
                     fromtime["fromtime1(4i)"].to_i, fromtime["fromtime1(5i)"].to_i)
        
        totime = params[:totime]
        @totime1 = DateTime.new( totime["totime1(1i)"].to_i, totime["totime1(2i)"].to_i, totime["totime1(3i)"].to_i, 
                     totime["totime1(4i)"].to_i, totime["totime1(5i)"].to_i)
